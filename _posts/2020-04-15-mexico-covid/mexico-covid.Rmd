...
```{r modelo, echo=FALSE, fig.cap="Modelo de predicción. Se puede observar la relación entre los diferentes parámetros en el modelo.",fig.align="center"}
...
```{r repro,message=FALSE, warning=FALSE, tidy=TRUE,fig.width=10,preview=TRUE, fig.height=8,fig.width=12,fig.cap=paste("Efecto de las intervenciones en","~ R[t]")}
